  ...
  return (
    <div className="deal-page">
            ...
            <div className="track">
              ...
              <div className="track-item">
                ...
                <div className="track-card">
                  ...
                  <div className="tc-note">Remaining {Math.round((data.balanceAmount / data.fixedFee) * 100)}% of fixed fee (₹{formatCurrency(data.balanceAmount)}) + 18% GST<br/></div>
                </div>
              </div>
              {data.hasPerformanceFee && (
      ...
      <div className={`sheet ${helpOpen ? 'on' : ''}`}>
        ...
        <a className="call-btn" href="tel:+917023937272">
