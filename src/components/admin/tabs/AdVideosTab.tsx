...
export default function AdVideosTab({ orgId }: { orgId: string }) {
              ...
              <CardContent className="pt-4">
                <div className="flex items-start justify-between gap-3">
                  ...
                  <div className="flex items-center gap-1 shrink-0">
                    ...
                    <button onClick={() => handleDelete(video._id)} className="p-2 rounded-lg hover:bg-[rgba(239,68,68,0.1)] text-[#64748b] hover:text-[#f87171] transition-colors cursor-pointer">
