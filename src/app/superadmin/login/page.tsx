...
function SuperadminLoginForm() {
  ...
  const callbackUrl = searchParams.get('callbackUrl') || '/superadmin/finances';
    ...
    <div className="admin-login-page">
      ...
      <div className="admin-login-container">
        <div className="admin-login-brand">
          ...
          <p className="admin-login-subtitle">Superadmin Console</p>
        </div>

        <div className="admin-login-card">
          <div className="admin-login-card-header">
            <h2 className="admin-login-card-title">Superadmin sign-in</h2>
          ...
          <form onSubmit={handleSubmit} className="admin-login-form">
            ...
            <div className="admin-login-field">
              <label htmlFor="superadmin-email" className="admin-login-label">
                Email Address
              </label>
              <div className="admin-login-input-wrapper">
                ...
                <input
                  ...
                  placeholder="superadmin@yuvichaar.com"
                  required
                  autoComplete="email"
            ...
            <div className="admin-login-field">
              <label htmlFor="superadmin-password" className="admin-login-label">
                Password
              </label>
              <div className="admin-login-input-wrapper">
          ...
          <div className="admin-login-footer">
            <p>Restricted area · Superadmin access only</p>
          </div>
        </div>
      </div>
      ...
      <style jsx>{`
        ...
        .admin-login-title-white { color: #f8fafc; }
        .admin-login-title-pink { color: #f472b6; }
        ...
        .admin-login-toggle-pw:hover { color: #cbd5e1; }
        ...
        .admin-login-submit:hover::before { opacity: 1; }
